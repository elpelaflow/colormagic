/**
 * Formatos de color de la tool All Colors.
 *
 * Las conversiones base (`hexToRgb`, `rgbToHex`, `rgbToHsl`, `hslToRgb`,
 * `normalizeHex`, `getContrastTextColor`) viven en la utilidad canónica
 * `layers/common/utils/color-converter.util.ts` y se re-exportan desde acá
 * para no romper los imports existentes de `~/layers/all-colors/utils/...`.
 *
 * Este archivo conserva los modelos específicos de All Colors: HSV, CMYK,
 * XYZ, CIE-LAB, Hunter-LAB, Yxy, YUV, tintes/sombras y ΔE2000.
 */
import {
  hexToRgb,
  rgbToHex,
...
export type { Rgb, Hsl };
export { hexToRgb, rgbToHex, rgbToHsl, hslToRgb, normalizeHex, getContrastTextColor };
