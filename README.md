...
The site has translations for [english](https://magicolor.app), [japanese](https://magicolor.app/ja) and [italian](https://magicolor.app/it) using [nuxtjs/i18n](https://i18n.nuxtjs.org/).
